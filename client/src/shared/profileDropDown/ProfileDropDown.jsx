  ...
  return (
    <div ref={dropdownRef} className="relative inline-block text-left">
      <button
        ...
        className="flex items-center gap-1 md:gap-2 rounded-full bg-[#000] px-4 py-2 text-sm font-medium text-white hover:bg-[#000000c9] focus:outline-none cursor-pointer capitalize"
      >
        {firstWord}
        <ChevronDown
